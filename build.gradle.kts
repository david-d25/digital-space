...
dependencies {
    ...
    implementation("com.fasterxml.jackson.datatype:jackson-datatype-jsr310") // To support ZonedDateTime in Jackson
    implementation("com.fasterxml.jackson.datatype:jackson-datatype-jdk8") // To support Optional in Jackson
    ...
    // todo upgrade to "tools.jackson.module:jackson-module-kotlin:3.0.3"
